...
initial_features_engineered <- zip2feat_data %>% 
  ...
  dplyr::select(b_idas_mean, population:median_household_income,clinician_count,clinicians_per_100k_county_population,
...
zip_initial_split <- initial_split(initial_features_engineered, prop = 3/4, strata = "screen_positive_for_internalizing_disorder")
